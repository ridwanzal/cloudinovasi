          ...
          <div class="col-md-6">
            <div class="card">
              <div class="card-body">
                ...
                <p class="card-text">Rp. 0,00&nbsp;&nbsp;<span style="cursor:pointer;" class="badge badge-primary">Top Up Balance</span></p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div role="tabpanel" class="tab-pane active" id="infra">
              ...
              <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-xs-12">
                    <input type="text" class="form-control" id="serarch" placeholder="">
                </div>
              </div>
              <div>
            </div>
